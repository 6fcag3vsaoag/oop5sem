...
int main() {
    ...
    std::cout << "Лабораторная работа №7. Моделирование гаражной стоянки\n";
    std::cout << "Команды:\n";
    ...
    while (true) {
        ...
        if (command == "q" || command == "Q") {
            ...
            std::cout << "Неизвестная команда. Доступные команды: a, d, s, q\n";
        }
        
        // Отображаем текущее состояние стоянки (только если это не команда демонстрации)
